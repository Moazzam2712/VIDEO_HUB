...
const Videos = () => {
    ...
    return <Stack direction={['column', 'row']}
        ...
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p={'8'} overflowY={'auto'}>
                ...
                <Text>This is a sample video for testing and demo.This is called Description.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum repellendus, aperiam rerum natus eius voluptates vero nemo impedit ab laborum deleniti quis eum itaque magnam ipsa porro eveniet veritatis sint sapiente iusto quasi.
                </Text>
        ...
        <VStack w={['full', 'xl']} overflow={'auto'} alignItems={'stretch'} p={'8'} spacing={'8'}>
            {
